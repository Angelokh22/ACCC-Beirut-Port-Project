                    ...
                    <ul class="d-flex ms-auto navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><span class="dropdown-item greatings" href="#">Hello, <span id="name">Zoulfikar</span></span></li>
            ...
            <div class="offcanvas-body p-0">
                <nav class="navbar-dark">
                    <ul class="navbar-nav">
                        ...
                        <!-- <li>
                            <a class="nav-link px-3 sidebar-link" data-bs-toggle="collapse" href="#action">
                                <span class="me-2">
                                    <i class="fa-solid fa-gavel fa-flip-horizontal"></i>
                                </span>
                                <span>Actions</span>
                                <span class="ms-auto">
                            ...
                            <div class="collapse" id="action">
                                <ul class="navbar-nav ps-3">
                                    <li>
                                        <a href="../actions/actions-list.php" class="nav-link px-3">
                                            <span class="me-2">
                                                <i class="bi bi-card-list"></i>
                                            </span>
                                            <span>View Actions List</span>
                                        </a>
                                        <a href="../actions/edit-actions.php" class="nav-link px-3">
                                            <span class="me-2">
